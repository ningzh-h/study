...
#
# Script generated by Vivado on Fri Apr 18 14:23:31 +0800 2025
...
# script info
echo -e "axi_bram_ctrl_0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_bram_ctrl_v4_1_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_bram_ctrl_0 xil_defaultlib.axi_bram_ctrl_0 xil_defaultlib.glbl -log elaborate.log
}
