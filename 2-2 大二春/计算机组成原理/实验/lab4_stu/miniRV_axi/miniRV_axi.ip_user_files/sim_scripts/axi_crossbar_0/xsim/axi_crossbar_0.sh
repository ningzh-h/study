...
#
# Script generated by Vivado on Fri Apr 18 14:23:37 +0800 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi_crossbar_0.sh
...
#
# Usage        : axi_crossbar_0.sh
#                axi_crossbar_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_crossbar_0.sh [-reset_run]
#                axi_crossbar_0.sh [-reset_log]
#                axi_crossbar_0.sh [-help]
#
...
export RDI_DATADIR="D:/Applications/Xilinx/Vivado/2024.2/data"
...
# script info
echo -e "axi_crossbar_0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_crossbar_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L generic_baseblocks_v2_1_2 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_33 -L fifo_generator_v13_2_11 -L axi_data_fifo_v2_1_32 -L axi_crossbar_v2_1_34 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_crossbar_0 xil_defaultlib.axi_crossbar_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_crossbar_0 -key {Behavioral:sim_1:Functional:axi_crossbar_0} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Applications/Xilinx/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_crossbar_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_crossbar_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_crossbar_0.sh [-help]\n\
Usage: axi_crossbar_0.sh [-step]\n\
Usage: axi_crossbar_0.sh [-lib_map_path]\n\
Usage: axi_crossbar_0.sh [-reset_run]\n\
Usage: axi_crossbar_0.sh [-reset_log]\n\
Usage: axi_crossbar_0.sh [-keep_index]\n\
Usage: axi_crossbar_0.sh [-noclean_files]\n\n\
