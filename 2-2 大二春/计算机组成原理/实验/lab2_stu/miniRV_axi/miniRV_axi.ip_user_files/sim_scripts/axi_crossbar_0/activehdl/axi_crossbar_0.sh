...
#                script (type 'axi_crossbar_0.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="N:/Study/Coding/RISC-V/lab2_stu/miniRV_axi/miniRV_axi.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
